...
#--------------------------Temporal evolution----------------------#
def evolution(int_method, Nt_step, dt, physics_params, w_ref, kp):
    ...
    for t in tt:
        ...
        V = kp * err            #calculate the new value of V (P control)
